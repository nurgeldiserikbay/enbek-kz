...
// UNUSED EXPORTS: adaptiveSwiper, autoExpand, autoScroll, counterAnim, getSelectedText, getWindowSize, grubScrolling, initToggleTags, modalFunc, socialsShareBlock, tabsHandler, txtAutoExpand
...
(0,_helper__WEBPACK_IMPORTED_MODULE_0__/* .swiperInit */ .UA)({
  ...
  nextBtnClass: '.history-slider__btn--right',
  prevBtnClass: '.history-slider__btn--left',
  spaceBetween: 0,
  loop: false,
  breakpoints: {
    780: {
...
;(0,_helper__WEBPACK_IMPORTED_MODULE_0__/* .swiperInit */ .UA)({
  perView: 2,
  className: '.structure-slider',
  nextBtnClass: '.structure-slider__btn--right',
  prevBtnClass: '.structure-slider__btn--left',
  spaceBetween: 16,
  loop: false,
  breakpoints: {
    1025: {
