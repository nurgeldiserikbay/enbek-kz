...
__webpack_require__.d(__webpack_exports__, {
  EP: () => (/* binding */ autoScroll),
  kE: () => (/* binding */ grubScrolling),
  hv: () => (/* binding */ initToggleTags)
});

// UNUSED EXPORTS: adaptiveSwiper, autoExpand, counterAnim, getSelectedText, getWindowSize, modalFunc, socialsShareBlock, swiperInit, tabsHandler, txtAutoExpand
...
(0,_helper__WEBPACK_IMPORTED_MODULE_0__/* .autoScroll */ .EP)(['category_id'])

;(0,_helper__WEBPACK_IMPORTED_MODULE_0__/* .initToggleTags */ .hv)({
  wrapClass: 'request-item',
  activeClass: 'request-item--active',
  togglerClass: 'request-item__head',
})

;(0,_helper__WEBPACK_IMPORTED_MODULE_0__/* .grubScrolling */ .kE)('.requests__tags', {
  left: '.contacts-page__head .slide-controls__btn--left',
  right: '.contacts-page__head .slide-controls__btn--right',
})
})();
