...
(0,_helper__WEBPACK_IMPORTED_MODULE_0__/* .swiperInit */ .UA)({
  perView: 1.3,
  className: '.project-list-slider',
  nextBtnClass: '.project-list-slider__btn--right',
  prevBtnClass: '.project-list-slider__btn--left',
  spaceBetween: 0,
  loop: false,
  breakpoints: {
    1025: {
...
;(0,_helper__WEBPACK_IMPORTED_MODULE_0__/* .tabsHandler */ .K2)({
  wrapClass: 'project-tab',
  activeTrigger: 'project-tab__head--active',
  activeTarget: 'project-tab__item--active'
})

;(0,_helper__WEBPACK_IMPORTED_MODULE_0__/* .grubScrolling */ .kE)('.project-tab__heads')
})();
