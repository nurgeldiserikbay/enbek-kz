...
__webpack_require__.d(__webpack_exports__, {
  kE: () => (/* binding */ grubScrolling),
  UA: () => (/* binding */ swiperInit),
  K2: () => (/* binding */ tabsHandler)
});

// UNUSED EXPORTS: adaptiveSwiper, autoExpand, autoScroll, counterAnim, getSelectedText, getWindowSize, initToggleTags, modalFunc, socialsShareBlock, txtAutoExpand
...
// EXTERNAL MODULE: ./node_modules/swiper/shared/classes-to-selector.mjs
var classes_to_selector = __webpack_require__(7869);
...
function Pagination(_ref) {
  ...
  function onBulletClick(e) {
    const bulletEl = e.target.closest((0,classes_to_selector.c)(swiper.params.pagination.bulletClass));
    if (!bulletEl) {
      return;
    }
    e.preventDefault();
  ...
  function update() {
    ...
    el.forEach((subEl, subElIndex) => {
      if (params.type === 'fraction') {
        subEl.querySelectorAll((0,classes_to_selector.c)(params.currentClass)).forEach(fractionEl => {
          fractionEl.textContent = params.formatFractionCurrent(current + 1);
        });
        subEl.querySelectorAll((0,classes_to_selector.c)(params.totalClass)).forEach(totalEl => {
      ...
      if (params.type === 'progressbar') {
        ...
        subEl.querySelectorAll((0,classes_to_selector.c)(params.progressbarFillClass)).forEach(progressEl => {
  ...
  function render() {
    ...
    el.forEach(subEl => {
      ...
      if (params.type === 'bullets') {
        swiper.pagination.bullets.push(...subEl.querySelectorAll((0,classes_to_selector.c)(params.bulletClass)));
      }
    });
    if (params.type !== 'custom') {
...
(() => {
/* harmony import */ var _helper__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(293);


(0,_helper__WEBPACK_IMPORTED_MODULE_0__/* .tabsHandler */ .K2)({
  wrapClass: 'lessons__list',
  activeTrigger: 'row-tab__head--active',
  activeTarget: 'row-tab__body-item--active',
  func: (ind) => {
    (0,_helper__WEBPACK_IMPORTED_MODULE_0__/* .swiperInit */ .UA)({
      init: false,
      perView: 1,
      className: '.culture-slider--' + ind,
      nextBtnClass: '.culture-slider--' + ind + ' .culture-slider__btn--right',
      prevBtnClass: '.culture-slider--' + ind + ' .culture-slider__btn--left',
      spaceBetween: 0,
      swiperCurrentClass: '.culture-slider--' + ind + ' .culture-slider__counter-ind',
      swiperCountClass: '.culture-slider--' + ind + ' .culture-slider__counter-total',
      loop: false,
    })
  }
})
...
;(0,_helper__WEBPACK_IMPORTED_MODULE_0__/* .tabsHandler */ .K2)({
  ...
  func: (ind) => {
    ;(0,_helper__WEBPACK_IMPORTED_MODULE_0__/* .swiperInit */ .UA)({
      init: false,
      perView: 1,
      className: '.holidays-slider--' + ind,
      nextBtnClass: '.holidays-slider--' + ind + ' .holidays-slider__btn--right',
      prevBtnClass: '.holidays-slider--' + ind + ' .holidays-slider__btn--left',
      spaceBetween: 0,
      swiperCurrentClass: '.holidays-slider--' + ind + ' .holidays-slider__counter-ind',
      swiperCountClass: '.holidays-slider--' + ind + ' .holidays-slider__counter-total',
      loop: false,
    })
  }
})
...
;(0,_helper__WEBPACK_IMPORTED_MODULE_0__/* .swiperInit */ .UA)({
  init: false,
  perView: 1,
  className: '.culture-slider--' + 0,
  nextBtnClass: '.culture-slider--' + 0 + ' .culture-slider__btn--right',
  prevBtnClass: '.culture-slider--' + 0 + ' .culture-slider__btn--left',
  spaceBetween: 0,
  swiperCurrentClass: '.culture-slider--' + 0 + ' .culture-slider__counter-ind',
  swiperCountClass: '.culture-slider--' + 0 + ' .culture-slider__counter-total',
  loop: false,
})
...
;(0,_helper__WEBPACK_IMPORTED_MODULE_0__/* .swiperInit */ .UA)({
  init: false,
  perView: 1,
  className: '.holidays-slider--' + 0,
  nextBtnClass: '.holidays-slider--' + 0 + ' .holidays-slider__btn--right',
  prevBtnClass: '.holidays-slider--' + 0 + ' .holidays-slider__btn--left',
  spaceBetween: 0,
  swiperCurrentClass: '.holidays-slider--' + 0 + ' .holidays-slider__counter-ind',
  swiperCountClass: '.holidays-slider--' + 0 + ' .holidays-slider__counter-total',
  loop: false,
})

;(0,_helper__WEBPACK_IMPORTED_MODULE_0__/* .grubScrolling */ .kE)('.vacancies__tags', {
  left: '.vacancies__head .slide-controls__btn--left',
  right: '.vacancies__head .slide-controls__btn--right'
})
...
function collapseTabs() {
  ...
  items.forEach((e) => {
    e.addEventListener('click', (node) => {
      const eHead = node.target.closest('.collapse-item__head')
      
      if (eHead) {
        e.classList.toggle('active')
        const slideClass = '.' + e.dataset.slideClass

        ;(0,_helper__WEBPACK_IMPORTED_MODULE_0__/* .swiperInit */ .UA)({
          init: false,
          perView: 1,
          className: slideClass,
          nextBtnClass: slideClass + ' .culture-slider__btn--right',
          prevBtnClass: slideClass + ' .culture-slider__btn--left',
          spaceBetween: 0,
          swiperCurrentClass: slideClass + ' .culture-slider__counter-ind',
          swiperCountClass: slideClass + ' .culture-slider__counter-total',
          loop: false,
        })
      }
    })
